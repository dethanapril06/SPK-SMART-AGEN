            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        {{-- Dashboard --}}
                        <li class="sidebar-item {{ request()->routeIs('calon-agen.dashboard') ? 'active' : '' }}">
                            <a href="{{ route('calon-agen.dashboard') }}" class="sidebar-link">
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="sidebar-item {{ request()->routeIs('calon-agen.notifikasi.*') ? 'active' : '' }}">
                            <a href="{{ route('calon-agen.notifikasi.index') }}" class="sidebar-link">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto mb-lg-0">
                                <li class="nav-item dropdown me-3">
                                    ...
                                    <ul class="dropdown-menu dropdown-center dropdown-menu-sm-end notification-dropdown"
                                        ...
                                        <li
                                            class="dropdown-header d-flex justify-content-between align-items-center px-3">
                                        ...
                                        @forelse ($notifikasiNavbar as $notif)
                                            <li
                                                class="dropdown-item notification-item {{ !$notif->is_read ? 'bg-light' : '' }}">
                                                <a class="d-flex align-items-center"
                                                    href="{{ route('calon-agen.notifikasi.read', $notif) }}">
                                                    <div
                                                        class="notification-icon bg-{{ match ($notif->tipe) {'direkomendasi' => 'success','belumdirekomendasi' => 'danger',default => 'primary'} }}">
                                                        <i
                                                            class="bi bi-{{ match ($notif->tipe) {'direkomendasi' => 'patch-check','belumdirekomendasi' => 'x-circle',default => 'info-circle'} }}"></i>
                                                    </div>
                                                    <div class="notification-text ms-3">
                                                        ...
                                                        <p
                                                            class="notification-subtitle font-thin text-sm text-muted mb-0">
                                        ...
                                        @if ($notifikasiNavbar->isNotEmpty())
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li>
                                                <a href="{{ route('calon-agen.notifikasi.index') }}"
                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            ...
                                            <p class="mb-0 text-sm text-gray-600">Calon Agen</p>
                                        </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="min-width: 11rem">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('calon-agen.dashboard') }}">
