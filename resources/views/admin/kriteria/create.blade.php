            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form form-vertical" method="POST" action="{{ route('admin.kriteria.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('kode_kriteria') }}" maxlength="10" required>
                                            @error('kode_kriteria')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('bobot') is-invalid @enderror"
                                                placeholder="Contoh: 25" id="bobot" name="bobot"
